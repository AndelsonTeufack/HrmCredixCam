...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String usernameOrEmailOrTelephone) throws UsernameNotFoundException {
        Employee employee = employeeRepository.findByUserNameOrAndEmailOrTelephone(usernameOrEmailOrTelephone, usernameOrEmailOrTelephone,usernameOrEmailOrTelephone)
                .orElseThrow(() ->
